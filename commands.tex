...
\NewDocumentEnvironment{ lecture } {O{} O{} +b} 
	{\addtocounter{lecturecount}{1} % increase counter
		\phantomsection % invisible page marker for hyperref
		\addcontentsline{toc}{subsection}{{#1}~Lecture:~\thelecturecount~{#2}} % add to table of contents
		\begin{trivlist} % begin unmarked ("trivial") list
...
\def\EC{\hyperlink{https://github.com/CarpenterEvan/PhysicsReview}{\(\mathbb{E}\textsc{van}~\mathbb{C}\textsc{arpenter}\)}}
\endinput