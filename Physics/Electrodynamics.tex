...
\subsubsection{Maxwell-Heaviside Equations}
\begin{align*}
...
\end{align*}
\subsubsection{Fields in Matter}
Fields inside media that are not vaccuum:
\subsubsection{Retarded Potentials}
\begin{align*}
	\vb{E}(\vb{x},t)&=\frac{q}{\ik}\qty{\qty[\oo{\gamma^2}\frac{\vb{R}-R\vb*{\beta}}{{\qty(R-\vb*{\beta}\cdot\vb{R})}^3}]_{\text{ret}}
