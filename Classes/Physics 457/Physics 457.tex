...
\end{lecture}
\begin{lecture}[Jan 7][Second Day]
    eV are a thng\\
...
\end{lecture}
\begin{lecture}[Jan 12][Finishing Special Relativity]
...
\end{lecture}
\begin{lecture}[Jan 14][Matter particles]
...
\end{lecture}
\begin{lecture}[Jan 19][Quark Confinement]
    Quark model 1960s
    \\
